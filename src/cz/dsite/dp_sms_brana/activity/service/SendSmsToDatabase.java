...
import cz.dsite.dp_sms_brana.R.id;
import cz.dsite.dp_sms_brana.R.layout;

import cz.dsite.dp_sms_brana.activity.ui.SettingsActivity;
import cz.dsite.dp_sms_brana.core.Token;
...
public class SendSmsToDatabase extends Activity {
		...
		btnSendSMS.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (phoneNo.length() > 0 && message.length() > 0)
					...
					uploadMessage("12345", message, phoneNo, "0000-00-00 00:00:00");
				else
	...
	// nahraje sms do databáze
	public void uploadMessage(String sender, String text, String phone, String date) {
