		  ...
		  new Thread(new Runnable() {
			    public void run() {
					...
					try{
							...
							nameValuePairs.add(new BasicNameValuePair("sender",author));				
							...
							nameValuePairs.add(new BasicNameValuePair("userid","1")); //id uživatele
		    ...
		    Toast.makeText(SendSmsToDatabase.this, "SMS byla odeslána do dataáze ", Toast.LENGTH_LONG).show();
			this.finish();
