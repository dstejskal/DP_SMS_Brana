package external.com.jjoe64.graphview;
...
import external.com.jjoe64.graphview.GraphViewSeries.GraphViewSeriesStyle;
import external.com.jjoe64.graphview.compatible.ScaleGestureDetector;
	...
	private class GraphViewContentView extends View {
		...
		protected void onDraw(Canvas canvas) {
			...
			for (int i = 0; i < horlabels.length; i++) {
				...
				{
					paint.setTextAlign(Align.CENTER); //Pùvodnì RIGHT
					x=x-5;
				}
				if (i==0)
				{
					paint.setTextAlign(Align.CENTER);  //Pùvodnì LEFT
					x=x+10;
				}
				paint.setColor(graphViewStyle.getHorizontalLabelsColor());
		
				/*Vertikální popisky u horizontální osy*/
				canvas.save();
			    canvas.rotate(-90,x,height-32);
				canvas.drawText(horlabels[i], x, height-32, paint); 
				canvas.restore();
